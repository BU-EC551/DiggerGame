...
xst -ifn xst.scr
move clk_top_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk_top_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_top_exdes.ucf clk_top_exdes

echo 'Running map'
map -timing -pr b clk_top_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clk_top_exdes -w routed.ncd routed.v
cd ..
